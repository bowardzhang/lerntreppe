...
LESETEXT = (
    "Die kranke Prinzessin (Italienisches Maerchen)\n\n"
    "Es war einmal eine Hauptstadt eines grossen Reiches, in der herrschte "
    ...
    "Koenigs liege schwer krank danieder - sie ruehre sich nicht mehr und esse "
    ...
    "der Koenig wolle seine Tochter demjenigen zur Frau geben, der sie retten "
    "wuerde - und damit niemand an der Richtigkeit dieses Versprechens zweifle, "
    "hatte der Koenig selbst seine Unterschrift beigefuegt.\n\n"
    ...
    "einem grossen Baum eine Einsiedlerklause. Er bat den alten weissbaertigen "
    "Einsiedler um Nachtherberge. Dieser sagte: 'Recht gerne, allein ich habe "
    "ueber meiner Klause nur einen Dachboden mit weichem Mooslager, wo du dich "
    ...
    "Juengling hinaufstieg und muede wie er war, bald einschlief.\n\n"
    "Um Mitternacht erwachte er. Auf dem grossen Baum neben der Klause sassen "
    ...
    "Schadenfreude, wie sie in der Stadt die Tochter des Koenigs so behext habe, "
    ...
    "Am Morgen des dritten Tages stand er an der Treppe der Koenigssburg. Der "
    "Koenig liess ihn vor und gestattete ihm den Heilungsversuch. Der Juengling "
    "liess sich in die Kueche fuehren, tat was er zu tun hatte, trat in das "
    ...
    "Der Koenig hielt sein Versprechen um so lieber, je mehr der Juengling auch "
...
QUESTIONS = [
    {
        ...
        "text": (
            ...
            "Leben ist?\n"
            "(b) Was verspricht der Koenig demjenigen, der seine Tochter heilen kann?\n"
        ...
        "answer": (
            ...
            "(b) Der Koenig verspricht demjenigen, der sie heilen kann, seine "
            "Tochter zur Frau. ; "
    ...
    },
    {
        ...
        "text": (
            ...
            "(rot) Warum hat der Koenig auf den Plakaten seine Unterschrift beigefuegt?\n"
    ...
    },
    {
        ...
        "text": (
            ...
            "dem Dachboden nicht ueberleben koennte.\n"
            "(3) Pantoffel ist in diesem Maerchen der Name einer Hexe.\n"
            "(4) Der Juengling erwacht, weil er laute Schreie und Gebruell hoert.\n"
            "(5) Der Juengling braucht vier Tage, bis er an der Koenigssburg ankommt.\n"
    ...
    },
    {
        ...
        "type": "Fragen in ganzen Sätzen",
        "text": (
            "Antworte in ganzen Saetzen:\n"
            "(a) Was braucht der Juengling, um die Medizin fuer die Prinzessin "
            "herzustellen?\n"
            "(b) Wie koennte sich der Koenig fuehlen, als seine Tochter wieder "
            "gesund aufwacht?\n"
        ...
        "answer": (
            ...
            "(b) Er koennte sich sehr gluecklich und erleichtert fuehlen. ; "
    ...
    },
    {
        ...
        "text": "Nenne 3 Merkmale, an denen du erkennst, dass es sich um ein Maerchen handelt.",
        "answer": (
