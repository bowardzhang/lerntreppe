...
QUESTIONS = [
    {
        ...
        "text": (
            ...
            "- Vermeide Wortwiederholungen. Denke an Satzanfaenge und Wortfelder.\n"
            "- Verwende woertliche Reden."
        ),
        "answer": (
            ...
            "- woertliche Reden eingebaut (1) ;\n"
            "- abwechslungsreiche Satzanfaenge, keine Wiederholungen (1) ;\n"
        ...
        "steps": [
            "Maerchenmerkmale beachten: Zahlen 3 und 7, Gut/Boese, Schluss-Satz.",
            "Aufbau klar gliedern.",
            "Mindestens 3 Abenteuer/Aufgaben einbauen.",
