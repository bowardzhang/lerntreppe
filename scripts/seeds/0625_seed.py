...
LESETEXT = (
    ...
    "Aussaetzigen und baute ihnen ein Spital. Tag für Tag speiste sie viele "
    "Notleidende. Ja, sie verkaufte sogar ihre Juwelen und kostbaren Kleider, "
    "um den Armen helfen zu können.\n\n"
    "Die Hofleute auf der stolzen Wartburg liebten ein prunkvolles, ueppiges "
    "Leben. Diese Leute beklagten sich oft bei Landgraf Ludwig über die "
    ...
    "zurück. Da begegnete ihm Elisabeth. Sie trug im hochgerafften Mantel "
    ...
    "Winter voll weisser und roter Rosen. Ludwig staunte und freute sich über "
    "dieses Wunder. Von da an liebte er Elisabeth noch mehr.\n\n"
    "Groß war Elisabeths Schmerz, als ihr Gatte auf einem Kreuzzug starb. Nun "
    "widmete sie sich noch mehr den Armen und Kranken. Schließlich lebte sie "
    ...
    "spaeter wurde sie heiliggesprochen. Über ihrem Grab in Marburg wurde die "
...
QUESTIONS = [
    ...
    },
    {
        ...
        "text": (
            ...
            "erklaere, warum deren Verhalten für uns ein Vorbild sein soll."
        ),
        "answer": (
