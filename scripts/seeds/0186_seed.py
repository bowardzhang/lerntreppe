EXERCISE = {
    ...
    "subject": "HSU",
    "grade": 4,
    "title": "Lernzielkontrolle: Wasser und Wetter",
    "topic": "Wasserkreislauf, Niederschlag, Wettergeraete, Grundwasser",
    "publisher": "CATLUX",
    "source_pdf": "0186.pdf",
    "answer_pdf": "0186 (1).pdf",
    "total_points": 38.0,
}
...
QUESTIONS = [
    {
        "n": 1,
        "type": "Wasserkreislauf beschreiben",
        "text": (
            "Finde eine Ueberschrift zu dem Bild und beschreibe zu jeder "
            "Nummer, was hier passiert! Verwende Fachbegriffe!"
        ),
        "answer": (
    ...
    {
        "n": 2,
        "type": "Begriff kondensieren",
        "text": "Was versteht man unter dem Begriff 'kondensieren'?",
        "answer": (
            "Wasserteilchen werden wieder sichtbar, sie verdichten sich zu "
            "Wassertropfen."
        ),
        "steps": ["Aggregatzustand-Wechsel von Gas zu Fluessigkeit."],
        "points": 3.0,
        "has_image": False,
        "image": None,
        "knowledge": ["hsu.klasse3.wasser.kreislauf"],
    ...
    {
        "n": 4,
        "type": "Grundwasser erklaeren",
        "text": "Was ist Grundwasser? Erklaere genau!",
        "answer": (
    ...
    },
    {
        ...
        "type": "Bodenarten",
        "text": (
            "Nach dem Regen versickert das Wasser in der Erde. Nenne je "
            "zwei Bodenarten!\n"
            "Wasserdurchlaessig: ___\n"
            "Wasserundurchlaessig: ___"
        ),
        "answer": (
            "Wasserdurchlaessig: Erde, lockerer Kies, Sand.\n"
            "Wasserundurchlaessig: Lehm/Ton, festes Gestein."
        ),
        "steps": ["Eigenschaften der Boeden vergleichen."],
        "points": 4.0,
        "has_image": False,
        "image": None,
        "knowledge": ["hsu.klasse3.wasser.kreislauf"],
    },
    {
        ...
        "answer": (
            ...
            "2. Beim Einseifen und Zaehne putzen Wasser abstellen.\n"
            "3. Bei der Toilettenspuelung nicht bis zum Schluss spuelen "
            "(Hebel nach oben oder Wasserstopptaste druecken).\n"
            "Weitere: tropfende Wasserhaehne melden, Geschirr nicht unter "
            "fliessendem Wasser waschen, Vorplatz mit Besen statt Wasser "
            "reinigen, Garten mit gesammeltem Regenwasser giessen."
        ),
        "steps": ["Drei konkrete Spar-Tipps nennen."],
        "points": 3.0,
        "has_image": False,
        "image": None,
    ...
    },
    {
        ...
        "answer": "Tau, Reif, Hagel, Schnee.",
        "steps": ["Vier Niederschlagsarten zuordnen."],
        "points": 4.0,
        "has_image": False,
        "image": None,
    ...
    },
    {
        ...
        "type": "Wettergeraete",
        "text": (
            "Beschrifte die Geraete und schreibe darunter, was man damit "
            "messen kann!"
        ),
        "answer": (
            "Niederschlagsmesser - Regenmenge\n"
