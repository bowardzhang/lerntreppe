...
QUESTIONS = [
    {
        ...
        "text": (
            ...
            "Schatz - Hoehle - Geiz - Strafe - Gold - Drache - schoenes "
            "Maedchen - 3 Aufgaben - Belohnung - Hochzeit - Zauberer - 3 Wuensche."
        ),
        "answer": (
            "Beurteilungs-Leitfaden:\n"
            "- maerchentypischer Anfangssatz (1) ;\n"
            "- klare Maerchenfiguren: Gut/Boese identifizierbar (1) ;\n"
            "- Problem der Hauptperson genannt (1) ;\n"
            "- 3 oder mehr Abenteuer/Aufgaben (2) ;\n"
            "- Schluss: Problem geloest, Bose bestraft (1) ;\n"
            "- maerchentypischer Schlusssatz (z. B. '... und wenn sie nicht "
            "gestorben sind ...') (1) ;\n"
        ...
        "steps": [
            "10-Punkte-Leitfaden zum Maerchenschreiben anwenden.",
            "Beginn: 'Es war einmal' / 'Vor langer Zeit'.",
            "Hauptteil: 3 Aufgaben oder Abenteuer (Steigerung).",
            "Schluss: Problem geloest, Belohnung, typischer Schlusssatz.",
        ],
        "points": 10.0,
        "has_image": False,
        "image": None,
